...
public class Main extends SimpleApplication {
    ...
    public static void main(String[] args) {
        ...
        settings.setWindowSize(1280, 720); //TODO: Needs to automatically get the resolution of the monitor otherwise it is upscaled when in full screen mode (looks ugly)
